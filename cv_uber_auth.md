...
**Languages & Frameworks:** Python, Java, Go, TypeScript, Node.js, Spring Boot, Django/Flask, gRPC, REST APIs

**Security & Identity:** Authentication/Authorization (AuthN/AuthZ), SSO, MFA, Session/token flows, IAM, Keycloak, Least privilege, Access controls, Secure deployments

**Distributed Systems & Observability:** Microservices, APIs, Async workflows, Service-to-service integrations, Prometheus, Grafana, Metrics/logs/traces, On-call incident response, SLA improvement

**Platforms & Infrastructure:** AWS, Azure, Docker, Kubernetes, Terraform, Git/GitHub, CI/CD, PostgreSQL, MongoDB, Redis, Linux

...
Senior Software Engineer with 8+ years of experience across full-stack development, cloud infrastructure, data engineering, and production operations. Proficient in Python, JavaScript/TypeScript, Java, and C#, with deep expertise in AWS, Azure, and infrastructure-as-code (Terraform, Docker). Hands-on experience migrating legacy systems to the cloud, building ETL pipelines, and designing AI-powered internal tooling. Currently at Goldman Sachs, providing SRE support for FX, Fixed Income, and Commodities (FICC) trading platforms across São Paulo, London, and New York — combining incident management with hands-on development of RAG-based knowledge systems and automated reporting solutions.

## Technical Skills

**Languages & Technologies:** Python, JavaScript, TypeScript, Java, C#, Node.js, React.js, Django/Flask, Spring Boot, AngularJS

**Platforms & Infrastructure:** AWS, Azure, Docker, Terraform, Git/GitHub, REST APIs, GraphQL, PostgreSQL, MongoDB, Redis, CI/CD, Apache Kafka, RabbitMQ, Linux

**AI / ML:** LLM orchestration, RAG (Retrieval-Augmented Generation), AI-assisted documentation, developer productivity tooling
...
- Developed APIs in TypeScript for a blockchain-based digital banking platform.

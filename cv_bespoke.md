# Samuel Toyoshi Ishida — Senior Backend & DevOps Engineer
...
8+ years as senior backend engineer — building, deploying, and operating production services. Deep expertise in Kubernetes, Terraform, CI/CD, Go, Python, and Java. Migrated 200+ on-premise applications to AWS with infrastructure-as-code. Resolved complex incidents in distributed systems, documenting outages, scaling strategies, and secure deployments into runbooks. Currently at Goldman Sachs SRE for FICC trading platforms (FX, Fixed Income, Commodities).

## Technical Skills

**Backend & Languages:** Go, Python, Java, TypeScript, Node.js, gRPC, REST APIs, GraphQL, microservices

**DevOps & Infrastructure:** Kubernetes, Terraform, Docker, AWS, Azure, CI/CD (GitLab CI, GitHub Actions), IaC, Linux, Nginx

**Identity, Security & Observability:** IAM, Keycloak, Prometheus, Grafana, distributed tracing, structured logging, incident response, secure deployments

**Data & Messaging:** PostgreSQL, MongoDB, Redis, Apache Kafka, RabbitMQ, MySQL, ETL pipelines
...
- **B.S. Computer Engineering** — UNICAMP (2014–Feb 2019)

## Certifications & Highlights

- **Foundations of Cybersecurity** — Google
- **Cambridge B2 First** — 169 (Full Professional English)

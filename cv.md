...
- **Bachelor's Computer Engineering** — UNICAMP (2014 – Feb 2019)

## Certifications & Highlights

- **Foundations of Cybersecurity** — Google
- **Cambridge B2 First** — Score 169 (Professional English)
- **OBI — Silver Medal** (Brazilian Olympiad in Informatics)
- **Member of UNICAMP Phoenix Robotics Team** (2014–2016): Autonomous robot with visual cone recognition (OpenCV, Python)

## Languages

- **Portuguese:** Native
- **English:** Professional (Cambridge B2 First, 169)